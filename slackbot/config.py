...
BOT_EXTRA_PLUGIN_DIR = '/opt/slackbot/plugins'
...
BOT_LOG_FILE = '/opt/slackbot/err.log'
...
#
{% if admins %}
BOT_ADMINS = ({% for admin in admins %}'{{ admin }}', {% endfor %})
{% endif %}
...
{% if rooms %}
CHATROOM_PRESENCE = ({% for room in rooms %}'{{ room }}', {% endfor %})
{% endif %}
